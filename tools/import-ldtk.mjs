 ...
 * src/engine/levels/.
 *
 *   node tools/import-ldtk.mjs        # or: pnpm run level:import
 *
...
// Edit the .ldtk file in LDtk, then run \`pnpm run level:import\`.
...
for (const source of sources) {
  ...
  console.log(
    `${source} -> src/engine/levels/${name}.ts (${level.cols}x${level.rows}, ` +
