    ...
    >
      ...
      <ContextMenu.Portal>
        <ContextMenu.Content className={menu} onCloseAutoFocus={(e) => e.preventDefault()}>
          ...
          {many && (
            <ContextMenu.Item className={ctxItemCls()} onSelect={() => editor.store.clearSelection()}>
                ...
                <SceneRowMenu inst={inst} selectedCount={selectedCount}>
                  ...
                  >
                    ...
                    <span className="flex flex-col gap-px min-w-0">
                      <span className="whitespace-nowrap overflow-hidden text-ellipsis">{def.name}</span>
